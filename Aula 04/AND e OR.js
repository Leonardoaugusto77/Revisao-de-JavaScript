...
if((pontos >=30 ) && (pontos <= 40) // = V 
  ...
  (pontos>= 70) && (pontos) <=80){ // = F
       ...
       console.log("Você Ganhou!") // Para não ficar tudo em uma linha é interessante não deixar tudo em uma linha, mas isso depende do tamanho da comparação que você que fazer!                        
} else{
